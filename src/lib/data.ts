...
export const profile = {
  ...
  roles: ["Web Developer", "App Developer", "Problem Solver", "Data nnotator"],
  email: "ananyasg1001@gmail.com",
  ...
  socials: {
    ...
    twitter: "https://x.com/",
    email: "mailto:ananyasg1001@gmail.com",
  },
  about: [
...
export const stats = [
  ...
  { value: 6, decimals: 0, suffix: " mo", label: "Professional Experience" },
...
export const experience = [
  {
    ...
    duration: "2 years",
    summary:
      "Got trained as a web developer. Built various projects including swiggy clone",
    highlights: [
      "Built 4 responsive dashboards using React and Tailwind CSS.",
      "Collaborated in daily Agile standups, participated in code reviews and pair programming",
    ],
    tech: ["React", "HTML5", "CSS", "JavaScript", "REST APIs", "Git"],
  },
  {
    id: "intern",
    role: "App Developer",
    company: "Dollarbird Technologies",
    location: "Mysuru",
    type: "Full Time",
    ...
    highlights: [
      "Converted Figma designs into pixel-perfect, mobile-first pages for client projects using HTML, CSS and JavaScript.",
      "Integrated REST APIs and forms, and wrote documentation.",
      "Received consistent mentor feedback for code clarity, naming conventions and attention to detail.",
    ],
    tech: ["HTML5", "CSS", "JavaScript", "React Native", "Git"],
  },
];
...
export const education = [
  {
    ...
    scoreType: "marks",
    highlights: [
      "Coursework: Data Structures, DBMS, Computer Networks, Operating Systems, Web Technologies, Artificial Intelligence and Machine Learning.",
      "Led a 4-member team in Final Year project. Prticipated in various competitions and Hackathons.",
      "Consistently ranked in the top 10 of the class.",
    ],
  },
  {
    id: "12th",
    ...
    field: "Science — Physics, Chemistry, Maths, Computer Science",
    specialization: "Mathematics & Computer Science",
    institution: "Vidya Vikas PU College, Mysuru",
    period: "2013-2015",
    score: "82.66%",
    scoreType: "marks",
    highlights: [
      "Third Topper in School and Second Topper in Computer Science.",
  ...
  },
  {
    ...
    scoreType: "marks",
    highlights: [
      "Participated in various competitions and school events.",
    ],
  },
];
